      ...
      <tbody class="divide-y divide-slate-100">
        ...
        <tr>
          ...
          <?php for ($t = 1; $t < $term; $t++): $pg = $priorGrades[$t][$student['id']] ?? null; ?>
            <td class="px-3 py-2 text-center text-slate-500"><?= $pg !== null ? h($pg) : '—' ?></td>
          <?php endfor; ?>
          ...
          <td class="px-3 py-2 text-center font-semibold text-accent-700" data-preview-transmuted="<?= (int) $student['id'] ?>"><?= $grade && $grade['transmuted_grade'] !== null ? h($grade['transmuted_grade']) : '—' ?></td>
          <?php if ($term === 3): ?>
